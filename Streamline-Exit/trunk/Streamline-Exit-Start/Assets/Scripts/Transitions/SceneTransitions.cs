...
public class SceneTransitions
{
    ...
    public static SceneTransition Transition<T>(Time time, string targetScene, Vector2 targetPosition) where T : SceneTransition
    {
        ...
        trans.targetPosition = targetPosition;
        return trans;
    }
}
